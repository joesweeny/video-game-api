...
class CommentServiceTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->service = new CommentService($this->repository->reveal(), new CommentPresenter());
    }
    ...
    public function test_getByUserId_returns_an_array_of_scalar_comment_objects()
    {
        ...
        $this->assertEquals('1da15c2e-f2fa-45ca-9c71-277428258931', $fetched[0]->user_id);
        $this->assertEquals('e09313c7-b55f-471f-81c2-47d879ad8dfd', $fetched[0]->game_id);
        ...
        $this->assertEquals('1da15c2e-f2fa-45ca-9c71-277428258931', $fetched[1]->user_id);
        $this->assertEquals('e09313c7-b55f-471f-81c2-47d879ad8dfd', $fetched[1]->game_id);
